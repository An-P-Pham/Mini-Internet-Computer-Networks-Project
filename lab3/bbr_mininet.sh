...
#   2. In terminal, go to lab3 folder and copy "file.txt" here 
#   3. In the same folder, run the script with "sudo ./bbr_mininet.sh [551_HOME_PATH]",
